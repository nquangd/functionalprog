...
package object barneshut {
  ...
  extends Quad {
    ...
    val mass = bodies.foldLeft(0f)((acc:Float,b:Body) => acc + b.mass)
    val massX = bodies.foldLeft(0f)((acc:Float,b:Body) => acc + b.mass * b.x)/mass
    val massY = bodies.foldLeft(0f)((acc:Float,b:Body) => acc + b.mass * b.y)/mass
