  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      ...
      if ((x1 < 0)) {
        ...
        var array$1 = [((minusb + sqrtdelta) / twoa), ((minusb - sqrtdelta) / twoa)];
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var left = new $c_Lcalculator_Var().init___F0(expr);
  ...
  $c_Lcalculator_Signal.prototype.update__F0__V.call(left, expr$1);
  $m_Lcalculator_Signal$();
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(left$1) {
    return (function() {
      return $uI(left$1.apply__O())
    })
  })(left));
